...
const ExecutiveSummary: React.FC = () => {
  ...
  const totalRecords = researchData.length > 0 ? researchData.length : datasetStats.totalRecords;
      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
            ...
            (2011-2022) reveals a strong correlation (r=
            {displayOverallCorr}) between alcohol and suicide mortality, driven primarily by male
            patterns. This isn't just about drinking— it's a male mental health emergency.
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <ul className=" text-gray-600 space-y-1">
                <li>• Overall correlation: r = {displayOverallCorr} (strong, male-driven)</li>
                <li>• Male correlation: r = {displayMaleCorr} (moderate, meaningful)</li>
        ...
        <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-6">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <h4 className="font-semibold text-blue-800 mb-3 text-sm">Important note</h4>
              <p className="text-blue-700 leading-relaxed text-sm">
                Data completeness is 96% with 33 missing combinations primarily affecting female
                records and small countries (UK missing 2019-2022 due to Brexit, Liechtenstein and
                Malta have gaps due to small populations).
              </p>
            </div>
          </div>
        </div>

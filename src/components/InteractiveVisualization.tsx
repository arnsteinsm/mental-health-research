...
const InteractiveVisualization: React.FC = () => {
  ...
  // Comparison Chart (existing functionality)
  useEffect(() => {
    ...
    if (genderView === 'combined') {
      ...
      // Separate male and female data (existing logic)
  ...
  }, [selectedCountries, selectedMetric, selectedYear, viewMode, genderView]);
  ...
  useEffect(() => {
    ...
    // Add lines
    timeSeriesData.forEach(countryData => {
      g.append("path")
  ...
  }, [selectedCountries, selectedMetric, viewMode]);
            ...
            <div>
              ...
              {viewMode === 'timeseries' && (
                <div className="text-sm text-gray-600 bg-blue-50 p-3 rounded">
                  <strong>Note:</strong> Time series shows male data trends from 2011-2022. 

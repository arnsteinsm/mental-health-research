...
import { countryNames, decadeResearchData } from '../data/decade-research-data';
import {
  detectUserCountry,
          ...
          <div className="text-center">
            ...
            <div className="bg-red-50 border border-red-200 rounded-xl p-8 max-w-2xl mx-auto">
              ...
              <p className="text-red-700 mb-4">
                We're experiencing difficulties loading the visualization data. Please check your
      ...
      <div className="container mx-auto px-6">
        ...
        {isLoading ? (
          ...
          <div className="bg-gray-50 rounded-2xl p-8 mb-8">
                    ...
                    <div className="p-2">
                      <div className="grid grid-cols-1 gap-1">
                        {filteredCountries.map((country) => (
                          <label
                            key={country}
                            className="flex items-center space-x-2 text-sm p-2 hover:bg-gray-50 rounded cursor-pointer"
                          >
                            <input
                              type="checkbox"
              ...
              <div>
                ...
                {viewMode === 'timeseries' && (
                  <div className="text-sm text-gray-600 bg-blue-50 p-3 rounded">
                    <strong>Note:</strong> Time series shows both male (solid line) and female
                    (dashed line) trends across the full dataset period (2011-2022). This highlights
                    the persistent gender disparities throughout the entire analysis period.
                  </div>
                )}
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm">
              {viewMode === 'comparison' ? (
                <svg ref={svgRef} width="800" height="500" className="w-full h-auto" />
              ) : (
                <svg ref={timeSeriesRef} width="800" height="400" className="w-full h-auto" />
              )}
              ...
              {hoveredData && (
                <div className="mt-4 p-4 bg-blue-50 rounded-lg border border-blue-200">
                  ...
                  <p className="text-sm text-gray-700">
                    <strong>{metrics[selectedMetric].label}:</strong>{' '}
                    {Number.parseFloat(hoveredData[selectedMetric]).toFixed(2)}{' '}
        ...
        >
          <h3 className="text-xl font-bold text-gray-900 mb-3">
            Full Dataset Insights (2011-2022)
          </h3>
          <div className="grid md:grid-cols-2 gap-4">
            <div>
              <h4 className="font-semibold text-gray-800 mb-2">Persistent Gender Disparities</h4>
              <p className="text-gray-700 text-sm leading-relaxed">
                Across the complete 12-year dataset (2011-2022), men consistently show dramatically
                higher rates in both alcohol and suicide metrics. This pattern persists across all
                countries and years, demonstrating the systemic nature of this crisis.
              </p>
            </div>
            <div>
              <h4 className="font-semibold text-gray-800 mb-2">Strong Correlation Evidence</h4>
              <p className="text-gray-700 text-sm leading-relaxed">
                The extended dataset strengthens our correlation findings, showing that where
                alcohol deaths are high, suicide rates follow—particularly among men. This
                relationship remains consistent throughout the entire analysis period.
              </p>
            </div>
          </div>
        </motion.div>

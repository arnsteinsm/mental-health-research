// apps/web/src/components/GenderAnalysis.tsx
			...
			<div className="container mx-auto px-6">
				...
				>
					...
					<p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed mb-8">
						The data reveals a complex web of interconnected factors that create
						a perfect storm of mental health vulnerability for men across
						Europe. These aren't isolated issues, they reinforce each other in a
						dangerous cycle.
					</p>
				</motion.div>
				...
				<div className="grid md:grid-cols-2 gap-8 mb-16 relative">
					...
					<div className="hidden md:block absolute inset-0 pointer-events-none z-0">
						...
						>
							<title>
								Connection lines showing relationships between analysis factors
							</title>
				...
				>
					...
					<p className="text-amber-800 text-sm leading-relaxed">
						These four factors don't operate in isolation, they're deeply
						interconnected. Economic pressure reinforces societal expectations,
						which amplifies mental health stigma, leading to social isolation,
						which cycles back to worsen all other factors. Breaking this cycle
						requires addressing all elements simultaneously.
					</p>
				</motion.div>
			</div>
		</section>
